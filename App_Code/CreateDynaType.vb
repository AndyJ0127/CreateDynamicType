...
Public Class CreateDynaType
    ...
    ''' </summary>
    ''' <param name="typeBuilder">傳入已經建立完成的 TypeBuilder 物件</param>
    ...
    Public Function Create_GenericCollectionType(typeBuilder As TypeBuilder, genericType As Type) As System.Type

        If (typeBuilder Is Nothing) = True OrElse (genericType Is Nothing) = True Then
            Return Nothing
        End If

        Return genericType.MakeGenericType(New Type() {typeBuilder.CreateType})
    ...
    Public Async Function Get_Json2Object_Async(typeName As String,
        ...
        Dim genericTbType As Type = Me.Create_GenericCollectionType(typeBuilder:=tb, genericType:=genericType)
